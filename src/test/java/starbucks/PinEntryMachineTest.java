...
public class PinEntryMachineTest
{
    ...
    @Test
    public void PinEntryMachineTest1()
    {
        pinEntry.number("1");
        pinEntry.backspace();
    ...
    @Test
    public void PinEntryMachineTest2()
    {
        pinEntry.number("1");
    ...
    @Test
    public void PinEntryMachineTest3()
    {
        pinEntry.number("1");
        pinEntry.number("2");
    ...
    @Test
    public void PinEntryMachineTest4()
    {
        pinEntry.number("1");
        pinEntry.number("2");
        pinEntry.number("3");
    ...
    @Test
    public void PinEntryMachineTest5()
    {
        pinEntry.number("1");
        pinEntry.number("2");
        pinEntry.number("3");
    ...
    @Test
    public void PinEntryMachineTest6()
    {
        pinEntry.number("1");
        pinEntry.number("2");
        pinEntry.number("3");
